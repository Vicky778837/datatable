class EcomOrdersController < ApplicationController
  ...
  private
    ...
    def ecom_order_params
      params.require(:ecom_order).permit(:price, :itek_sku, :purchase_date, :platform_order_num, :sales_channel, :status, :customer_name, :customer_state, :shipped_at, :num_items_shipped, :payment_method)
    end
end
